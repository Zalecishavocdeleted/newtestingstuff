...
const JSDELIVR_URL = `https://cdn.jsdelivr.net/gh/alecishavoc/gddatabase-webdashers@main/level_${levelId}.json`;
let gdMap = null;
...
try {
  ...
  if (jsdRes.ok) {
    const parsed = await jsdRes.json();
    if (parsed && parsed["1"]) {
      gdMap = parsed;
          ...
          try {
            ...
            if (ngText && ngText !== "-1") { 
              ...
              if (songUrl) {
                ...
                // ── jsDelivr song cache ───────────────────────────────────────────────
const JSDELIVR_SONG_URL = `https://cdn.jsdelivr.net/gh/alecishavoc/gddatabasesongs-webdashers@main/songs_${songIdRaw}.mp3`;
let arrayBuf = null;
try {
